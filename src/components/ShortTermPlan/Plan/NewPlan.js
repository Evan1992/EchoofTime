        ...
        <div>
            ...
            <form onSubmit={props.postPlanHandler} >
                <div className={classes.wrapper}>
                    ...
                    {/* <input type="text" value={props.short_term_plan.title} onChange={props.inputChangeHandler2} className={classes.column2} required/> */}

                    <div className={classes.column3}>Comment</div>
                    <textarea value={props.short_term_plan.comment} onChange={props.inputChangeHandler3} className={classes.column4} />
